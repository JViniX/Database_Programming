...
Set @Titulo = 'Jardins Consulta hono Part Med Int: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Jardins Consulta hono Part Med Int.xls',  
	@colheaders =1, 
