...
Set @Titulo = 'Consultas Hono Convênio Medico Externo: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Consultas Hono Convênio Medico Externo.xls',  
	@colheaders =1, 
