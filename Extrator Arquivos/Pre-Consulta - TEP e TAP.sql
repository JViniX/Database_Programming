...
Set @Titulo = 'Pré-Consulta TEP e TAP 2016'-- + CONVERT(CHAR(7),@Dia,127)
...
EXEC sp_makewebtask 
	...
	@query = '
select pac.pac_reg Registro, pac.pac_nome Paciente, psv.psv_fila_nome Fila, fle.fle_dthr_chegada Chegada, fle.fle_dthr_atendimento Inicio_Atend, fle.fle_dthr_final Fim_Atend, datediff(mi, FLE.FLE_DTHR_CHEGADA, FLE.FLE_DTHR_ATENDIMENTO) TEP, datediff(mi, FLE.FLE_DTHR_ATENDIMENTO, fle.fle_dthr_final) TAP
