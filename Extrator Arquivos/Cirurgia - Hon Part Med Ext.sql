...
Set @Titulo = 'Cirurgias Hono Part Med Ext: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Cirurgias Hono Part Med Ext.xls',  
	@colheaders =1, 
