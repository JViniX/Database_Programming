...
Set @Titulo = 'Jardins Exames ROB Conv: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Jardins Exames ROB Conv.xls',  
	@colheaders =1, 
...
inner join pac on i.smm_pac_reg = pac.pac_reg
			...
			AND( I.SMM_STR = ''JEX'' OR I.SMM_STR = ''JHE'')
