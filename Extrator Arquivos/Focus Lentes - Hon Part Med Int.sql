...
Set @Titulo = 'Focus Lentes hono Part Med Int: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Focus Lentes hono Part Med Int.xls',  
	@colheaders =1, 
