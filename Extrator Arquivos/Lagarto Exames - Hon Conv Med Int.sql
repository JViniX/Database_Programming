...
Set @Titulo = 'Lagarto Exames Hono Convênio Medico Interno: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Lagarto Exames Hono Convênio Medico Interno.xls',  
	@colheaders =1, 
