...
Set @Titulo = 'Focus Consulta Hono Convênio Medico Interno: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Focus Consulta Hono Convênio Medico Interno.xls',  
	@colheaders =1, 
