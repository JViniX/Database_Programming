...
Set @Titulo = 'Focus Consulta ROB Part: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Focus Consulta ROB Part.xls',  
	@colheaders =1, 
...
/*(SELECT ISNULL(SUM (I.SMM_QT),0)*/
			...
			AND (I.SMM_STR = ''COL'' OR I.SMM_STR = ''FC2'')
