...
Set @Titulo = 'Lagarto Exames hono Part Med Int: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Lagarto Exames hono Part Med Int.xls',  
	@colheaders =1, 
