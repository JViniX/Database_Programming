...
Set @Titulo = 'Lagarto Exames Hono Part NC: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Lagarto Exames Hono Part NC.xls',  
	@colheaders =1, 
