...
Set @Titulo = 'Focus Consultas Vol Cortesia: '+ convert(varchar(2),month(@MesAno))+'/'+convert(varchar(4),year(@MesAno))

EXEC sp_makewebtask 
	@outputfile = 'D:\Extratos\Focus Consultas Vol Cortesia.xls',  
	@colheaders =1, 
