...
/*(SELECT ISNULL(SUM (I.SMM_QT),0)*/
			...
			WHERE  O.OSM_DTHR >= '2015-01-01 00:00'--DATEADD(D,1-DAY(GETDATE()),DATEADD(M,-1,CONVERT(CHAR(8),GETDATE(),112))) 
			AND O.OSM_DTHR < '2015-02-01 00:00'--DATEADD(D,1-DAY(getdate()),CONVERT(CHAR(8),getdate(),112))
