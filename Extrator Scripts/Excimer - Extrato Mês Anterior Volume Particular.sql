...
/*(SELECT ISNULL(SUM (I.SMM_QT),0)*/
			...
			WHERE  i.smm_osm = '30949'
			--O.OSM_DTHR >= '2016-03-16'--DATEADD(D,1-DAY(GETDATE()),DATEADD(M,-1,CONVERT(CHAR(8),GETDATE(),112))) 
			--AND O.OSM_DTHR < '2016-03-16'--DATEADD(D,1-DAY(getdate()),CONVERT(CHAR(8),getdate(),112))
