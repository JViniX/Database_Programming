...
select i.smm_osm_serie "OS Serie", i.smm_osm "OS Num", i.smm_sfat "Status Fat", i.smm_str "Cod. Setor", s.str_nome "Setor", 
	i.SMM_COD , p.SMK_NOME, p.smk_pacote, i.smm_pacote, i.smm_qt Qtd, pac.pac_reg, pac.pac_nome, i.smm_med "CRM", crm.psv_nome "Prestador", o.osm_cnv "Cod. Conv.", c.cnv_nome "Convenio", c.CNV_CAIXA_FATURA "Cobraca",
...
/*(SELECT ISNULL(SUM (I.SMM_QT),0)*/
			...
			WHERE  i.smm_osm = '30494' AND i.smm_osm_serie = '116'
