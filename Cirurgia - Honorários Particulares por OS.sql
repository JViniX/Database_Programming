...
cc3.ccr_tit "Set Exec", isnull(h.hon_cc3, '99999') "Conta Set Exec", replace(cast(h.hon_pc3 as numeric(10,2)),'.',',')+'%' "% Rat Set Exec", 'R$'+replace(cast(h.hon_vl3 as numeric(10,2)),'.',',') "R$ Rat Set Exec", (((ISNULL(H.HON_PC3,0)*(I.SMM_VLR - (I.SMM_VLR* (M.MTE_DESCONTO/M.MTE_VALOR)) - ((ISNULL(H.HON_VL1,0)*I.SMM_QT) + (ISNULL(H.HON_VL2,0)*I.SMM_QT) + (ISNULL(H.HON_VL3,0)*I.SMM_QT) + (ISNULL(H.HON_VL4,0)*I.SMM_QT) + (ISNULL(H.HON_VL5,0)*I.SMM_QT) + (ISNULL(H.HON_VL6,0)*I.SMM_QT)))/100)+((ISNULL(H.HON_VL3,0)*I.SMM_QT)))) "R$ Hono Set Exec",
...
cc5.ccr_tit "Set solic", isnull(h.hon_cc5, '99999') "Conta Set solic", replace(cast(h.hon_pc5 as numeric(10,2)),'.',',')+'%' "% Rat Set solic", 'R$'+replace(cast(h.hon_vl5 as numeric(10,2)),'.',',') "R$ Set Med solic", (((ISNULL(H.HON_PC5,0)*(I.SMM_VLR - (I.SMM_VLR* (M.MTE_DESCONTO/M.MTE_VALOR)) - ((ISNULL(H.HON_VL1,0)*I.SMM_QT) + (ISNULL(H.HON_VL2,0)*I.SMM_QT) + (ISNULL(H.HON_VL3,0)*I.SMM_QT) + (ISNULL(H.HON_VL4,0)*I.SMM_QT) + (ISNULL(H.HON_VL5,0)*I.SMM_QT) + (ISNULL(H.HON_VL6,0)*I.SMM_QT)))/100)+((ISNULL(H.HON_VL5,0)*I.SMM_QT)))) "R$ Hono Set Solic",
...
(((ISNULL(H.HON_PC3,0)*(I.SMM_VLR - (I.SMM_VLR* (M.MTE_DESCONTO/M.MTE_VALOR)) - ((ISNULL(H.HON_VL1,0)*I.SMM_QT) + (ISNULL(H.HON_VL2,0)*I.SMM_QT) + (ISNULL(H.HON_VL3,0)*I.SMM_QT) + (ISNULL(H.HON_VL4,0)*I.SMM_QT) + (ISNULL(H.HON_VL5,0)*I.SMM_QT) + (ISNULL(H.HON_VL6,0)*I.SMM_QT)))/100)+((ISNULL(H.HON_VL3,0)*I.SMM_QT))))+
(((ISNULL(H.HON_PC4,0)*(I.SMM_VLR - (I.SMM_VLR* (M.MTE_DESCONTO/M.MTE_VALOR)) - ((ISNULL(H.HON_VL1,0)*I.SMM_QT) + (ISNULL(H.HON_VL2,0)*I.SMM_QT) + (ISNULL(H.HON_VL3,0)*I.SMM_QT) + (ISNULL(H.HON_VL4,0)*I.SMM_QT) + (ISNULL(H.HON_VL5,0)*I.SMM_QT) + (ISNULL(H.HON_VL6,0)*I.SMM_QT)))/100)+((ISNULL(H.HON_VL4,0)*I.SMM_QT))))+
(((ISNULL(H.HON_PC5,0)*(I.SMM_VLR - (I.SMM_VLR* (M.MTE_DESCONTO/M.MTE_VALOR)) - ((ISNULL(H.HON_VL1,0)*I.SMM_QT) + (ISNULL(H.HON_VL2,0)*I.SMM_QT) + (ISNULL(H.HON_VL3,0)*I.SMM_QT) + (ISNULL(H.HON_VL4,0)*I.SMM_QT) + (ISNULL(H.HON_VL5,0)*I.SMM_QT) + (ISNULL(H.HON_VL6,0)*I.SMM_QT)))/100)+((ISNULL(H.HON_VL5,0)*I.SMM_QT))))+
...
where
			...
			O.OSM_DTHR >= '2015-11-27 00:00' --DATEADD(D,1-DAY(GETDATE()),DATEADD(M,-1,CONVERT(CHAR(8),GETDATE(),112))) 
			AND O.OSM_DTHR < '2015-11-29 00:00' --DATEADD(D,1-DAY(getdate()),CONVERT(CHAR(8),getdate(),112))
			--and i.smm_vlr <> 0
