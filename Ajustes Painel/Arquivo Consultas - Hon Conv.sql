...
--Set @Dia = GETDATE()
Set @Titulo = 'Honorários Convênios 2016'--+ CONVERT(CHAR(10),@Dia,105)
...
where
			...
			o.OSM_DTHR >= DATEADD(D,1-DAY(@Dia),DATEADD(M,-1,CONVERT(varchar(23),@Dia,120))) 
			and o.OSM_DTHR < DATEADD(D,1-DAY(@Dia),CONVERT(varchar(23),@Dia,120))
